...
path = "E:\arko\Computer Programming 2 projects\data\dictionary.txt"
...
If op2 = vbYes Then
    ...
    rnum = Int(Rnd * 2) + 1
    If rnum = 1 Then
        path2 = "E:\arko\Computer Programming 2 projects\data\MaleNames.txt"
    ElseIf rnum = 2 Then
        path2 = "E:\arko\Computer Programming 2 projects\data\FemaleNames.txt"
    End If
    ...
    Next n
    path2 = "E:\arko\Computer Programming 2 projects\data\LastNames.txt"
    Open path2 For Input As #1
        i = 0
        Do While Not EOF(1)
            Line Input #1, strline
